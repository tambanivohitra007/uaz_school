                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                              foreach ($list  as $objet) {
                                                  ...
                                                  $url = base_url() . 'index.php/departement/popup/'. $objet['student_id'];
                                            ?>
                                                <td>
                                                    <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/departement/popup/<?php echo $objet['student_id']; ?>');" class="btn btn-danger btn-xs" id="voir"><i class="fa fa-eye"></i> Voir </a>
                                                    <?php
                                                      if ($objet['app_dean'] == 0){
                                                    ?>
                                                    <a href="#" onclick="showModalEdit('<?php echo base_url();?>index.php/departement/popupEdit/<?php echo $objet['student_id']; ?>');" class="btn btn-default btn-xs <?php echo $objet['student_id']; ?>" id="editer"><i class="fa fa-edit"></i> Editer </a>
