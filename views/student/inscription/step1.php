       ...
       <!-- Nom et prenoms -->
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12 form-group has-feedback">
              <input type="text" class="form-control has-feedback-left" id="nom" name="nom" placeholder="Votre Noms" value="<?php echo $student->student_nom; ?>">
        ...
        ?>
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Endroit: <span class="required">*</span>
            </label>
          ...
          <div class="form-group">
              ...
              <div class="col-md-3 col-sm-3 col-xs-12">
                  <select class="form-control" id="etude_envisage">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                <input id="student_tel" class="form-control has-feedback-left" required="required" type="text" placeholder="Téléphone" name="tel" value="<?php echo $student->student_tel; ?>" data-inputmask="'mask' : '999 99 999 99 - 999 99 999 99'">
